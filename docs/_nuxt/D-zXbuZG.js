import{Q as S,a4 as k,ag as O,a5 as w,d as m,a6 as A,N as V,c as p,o as g,a as h,h as y,O as z,v as I,m as s,t as B,ae as f,aL as c,af as C,F as K,q as $,j as x,aN as D,J as E}from"./CFvHMphb.js";var j=`
    .p-togglebutton {
        display: inline-flex;
        cursor: pointer;
        user-select: none;
...
`,W={root:function(e){var n=e.props,l=e.instance;return["p-selectbutton p-component",{"p-invalid":l.$invalid,"p-selectbutton-fluid":n.fluid}]}},Y=S.extend({name:"selectbutton",style:U,classes:W}),G={name:"BaseSelectButton",extends:O,props:{options:Array,optionLabel:null,optionValue:null,optionDisabled:null,multiple:Boolean,allowEmpty:{type:Boolean,default:!0},dataKey:null,ariaLabelledby:{type:String,default:null},size:{type:String,default:null},fluid:{type:Boolean,default:null}},style:Y,provide:function(){return{$pcSelectButton:this,$parentInstance:this}}};function X(t,e){var n=typeof Symbol<"u"&&t[Symbol.iterator]||t["@@iterator"];if(!n){if(Array.isArray(t)||(n=T(t))||e){n&&(t=n);var l=0,a=function(){};return{s:a,n:function(){return l>=t.length?{done:!0}:{done:!1,value:t[l++]}},e:function(d){throw d},f:a}}throw new TypeError(`Invalid attempt to iterate non-iterable instance.
